export class DotLottieAdapter {
  ...
  async setState(state) {
    ...
    if (marker && typeof this.runtime.setMarker === "function") {
      this.runtime.setMarker(marker);
    }
    return state;
  }
  ...
  async beginTransition(target) {
    ...
    if (typeof this.runtime.play === "function") {
      this.runtime.play();
    }
  ...
  async seek(progress) {
    if (typeof this.runtime.seek === "function") {
      this.runtime.seek(progress);
    }
  }
  ...
  async getVisualState() {
    return { runtime: "dotlottie", productState: this.productState };
  }
